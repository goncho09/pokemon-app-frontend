...
export default function Search() {
  ...
  return (
    <form className="flex justify-center flex-col items-center mt-48" onSubmit={onSubmit}>
      ...
      <div className="flex w-[30%] h-8 justify-center text-black ">
        <input
          ...
          value={search}
        />
        <button type="submit" className="bg-white p-2 rounded-r-lg " onClick={() => onSubmit}><FaMagnifyingGlass /></button>
      </div>
      {
